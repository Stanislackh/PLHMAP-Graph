...
def afficheBouton(fenetre):
    ...
    boutonCheckAll = Button(fenetre, text="Tout cocher", command=cocheTout, width=10, height=5)
    boutonCheckAll.pack(side=RIGHT, padx=5, pady=1)

    # Uncheck all checkboxes
    boutonUnchekAll = Button(fenetre, text="Tout Decocher", command=decocheTout, width=10, height=5)
